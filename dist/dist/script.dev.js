...
printText(styleGreen, 'fsdfsd sdf sdf sdf sg erwtw sdf sdfsdf sdf '); // Задание 2
...
var goodsListPrint = function goodsListPrint() {
  var total = 0;
...
var universityLiterature = university.filter(function (university) {
  return university.faculty === "literature";
});
console.log(universityLiterature);
var universityQuantity = university.filter(function (university) {
  return university.quantity === "13";
});
console.log(universityQuantity); // 6. Написать функцию, которая принимает минимальное и 
...
takeNumbers(); // 2. Написать функцию, которая возводит переданное число
// в указанную степень.
...
exponentNumber(); // 3. Написать функцию, которая принимает 2 числа и знак
...
console.log(calculatorOfNumbers()); // 4. Написать функцию, которая проверяет, является ли пере-
...
primeNumber(); // 5. Написать функцию, которая принимает число и выводит
...
multiplicationCalculator(); // 6. Написать функцию, которая реализует работу оператора %.
...
console.log(divideOst(11, 4)); // 7. Написать функцию, которая принимает от 1 до 5 чисел и
// возвращает их сумму.

function sumOfTheNumbersFromOneToFive(a, b, c, d, e) {
  if (b === void 0) {
    b = 0;
  }
...
console.log(sumOfTheNumbersFromOneToFive(9, 3, 4, 2, 3)); // 8.Написать функцию, которая принимает от 1 до 5 чисел и
// возвращает большее из них.

function theBiggestOfTheNumbersFromOneToFive(a, b, c, d, f) {
  if (b === void 0) {
    b = 0;
  }
...
console.log(theBiggestOfTheNumbersFromOneToFive(1, 2, 8, 4, 6)); // Module 2 week 2.
// Задание 1
// Создать массив из 10 случайных чисел и написать несколько
// функций для работы с ним.

var arr = [1, 2, 4, 6, 3, 4, 77, 334, 1, 2]; // 1. Функция принимает массив и выводит его на экран.

var myArray = [1, 2, 4, 6, 3, 4, 77, 334, 1, 2];

function myFunction(arr) {
  console.log(arr);
}

myFunction(myArray); // 2. Функция принимает массив и выводит только четные элементы.

var myArray1 = [1, 2, 4, 6, 3, 4, 77, 334, 1, 2];
var evens = myArray1.filter(function (number) {
  return number % 2 === 0;
});
console.log(evens); // 3. Функция принимает массив и возвращает сумму всех элементов массива.

var arr2 = [1, 2, 4, 6, 3, 4, 77, 334, 1, 2];
var result2 = arr2.reduce(function (sum, current) {
  return sum + current;
}, 0);
console.log(result2); // 4. Функция принимает массив и возвращает его максималь-ный элемент.

var arr3 = [1, 2, 4, 6, 3, 4, 77, 334, 1, 2];
var maxElement = Math.max.apply(null, arr3);
console.log(maxElement); // 5. Функция добавления нового элемента в массив по указанному индексу.

var numbers = [1, 2, 4, 5];
var index = 2;
var newNumbers = [numbers.slice(0, index), 3, numbers.slice(index)];
console.log(newNumbers); // 6. Функция удаления элемента из массива по указанному индексу.

var arrayOfNumbers = [1, 2, 3, 4];
var previousSecondElementOfTheArray = arrayOfNumbers.splice(1, 1);
console.log(arrayOfNumbers);
console.log(previousSecondElementOfTheArray); // Задание 2.
...
var b = [101, 2, 1, 10];
var c = ab.concat(b);
var da = c.filter(function (item, positive) {
  return c.indexOf(item) === positive;
});
console.log(da); // 2.Функция принимает 2 массива и возвращает новый массив,
// в котором собраны общие элементы (то есть элементы,
// которые встречаются и в первом и во втором массивах)
// без повторений.

var ae = [1, 2, 3, 5, 6, 8];
var be = [101, 2, 1, 10, 6, 8];
var commonElements = ae.filter(function (element) {
  return be.includes(element);
});
console.log([commonElements]); // 3. Функция принимает 2 массива и возвращает новый мас-
// сив, в котором собраны все элементы из первого массива,
// которых нет во втором массиве.

var ar = [1, 2, 3, 5, 6, 8];
var br = [101, 2, 1, 10, 6];
var commonElements1 = ar.filter(function (element) {
  return br.includes(element);
});
var newArrayWithoutCommonElements = ar.filter(function (element) {
  return !commonElements1.includes(element);
});
console.log([newArrayWithoutCommonElements]); // Module_2_Week_4
// Задание 1
...
var tags = new PrintMaсhine("16px", "#555", "calibri"); // Задание 2. Реализовать класс, описывающий новость (заголовок, текст,
...
console.log(result); // 2.Написать функцию, которая переводит в верхний регистр
...
console.log(ucFirst("germany")); // 3.Написать функцию, которая считает количество гласных
// букв в переданной строке.

var vowel_count = function vowel_count(string) {
  return __spreadArrays(string).filter(function (c) {
...
console.log(vowel_count('Hello, world!')); // 4.Написать функцию для проверки спама в переданной
...
console.log(checkSpam("innocent rabbit")); // 5.Написать функцию сокращения строки. Функция прини-
...
console.log(palindrome("A man, a plan, a canal. Panama")); // 7.Написать функцию, которая считает количество слов в
// предложении.
...
console.log(truncate("maximum power", 10)); // 8.Написать функцию, которая возвращает самое длинное
...
console.log(d1); // 2. Напишите функцию getWeekDay(date), показывающую день недели в коротком формате: «ПН», «ВТ», «СР», «ЧТ», «ПТ», «СБ», «ВС».
...
console.log(getWeekDay(date1)); // 3. В Европейских странах неделя начинается с понедельника (день номер 1), затем идёт вторник (номер 2) и так до воскресенья (номер 7). Напишите функцию getLocalDay(date), которая возвращает «европейский» день недели для даты date.
...
console.log(getLocalDay(date1)); // Module_1_Week_5.
...
console.log("factorial number " + d + " is equal to " + calculatingTheFactorial(d)); // 2. Написать функцию, которая выводит все числа из заданного пользователем диапазона в прямом порядке. И еще одну функцию – для вывода в обратном порядке.
...
console.log("Numbers in the back way: " + outputsNumbers1(start, end)); // 3. Написать функцию, которая выводит переданное ей число задом наперед. Например: число 1234 вывести как 4321.
...
console.log("Flip this number: " + flipTheNumber(num, num.length - 1)); // 4. Написать функцию, которая считает сумму цифр числа.
// Например: число 1357, сумма 1 + 3 + 5 + 7 = 16.

function sumDigitsOfTheNumber(s, i) {
  var sum; // console.log (s)
  // console.log (i)
...
console.log("Sum of digits in the number \"" + num + "\" is equal: " + sumDigitsOfTheNumber(num, num.length - 1)); // 5. Написать функцию, которая принимает число и выводит
...
console.log(brackets.join('')); // Module_1_Week_5. Во всех заданиях обязательно использовать рекурсию.
...
console.log("Result: " + weRaiseToADegree(the_number_being_exponentiated, degree)); // 2. Написать функцию поиска наибольшего общего делителя.
...
console.log("The Biggest divider: " + calculateTheGCD(num1, num2)); // 3. Написать функцию для поиска максимальной цифры в числе.
...
console.log("Maximum number: " + weFindTheMaximumFigure(six_digits)); // 4. Написать функцию, которая определяет простое ли переданное число.
...
console.log("Provided number " + simple_or_not1 + " - " + weIdentifyAPrimeNumber(simple_or_not1)); // 5. Написать функцию для вывода всех множителей переданного числа в возрастающем порядке.
...
console.log("Multiplier of the provided number " + factorization1 + " - " + weDecomposeIntoMultipliers(factorization1, a = [], 2).join('*')); // 6. Написать функцию, которая возвращает число Фибоначчи по переданному порядковому номеру.
...
console.log("Finding the index number " + numFib1 + " Fibonacci number " + calculateTheFibonacciNumber(numFib1)); // 1313. Дан список сообщений с кнопками для удаления [x]. Заставьте кнопки работать.
